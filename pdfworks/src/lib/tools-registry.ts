...
export const tools: Tool[] = [
  ...
  },
  {
    id: 'crop-pdf',
    name: 'Crop PDF',
    description: 'Crop and trim your PDF documents',
    category: 'pdf',
    icon: 'Crop',
    color: '#e74c3c',
    comingSoon: true,
  ...
  // ─── Missing tools (needed so routes resolve instead of 404) ──────────────
  {
    id: 'pdf-scanner',
    name: 'PDF Scanner',
    description: 'Scan documents and save them as PDFs directly in your browser',
    category: 'pdf',
    icon: 'ScanLine',
    color: '#e74c3c',
    comingSoon: true,
    route: '/tools/pdf-scanner',
  },
  {
    id: 'image-cropper',
    name: 'Image Cropper',
    description: 'Crop and trim your images to the perfect size',
    category: 'image',
    icon: 'Crop',
    color: '#2ecc71',
    comingSoon: true,
  ...
  },
  {
    ...
    description: 'Export frames from a video as image files',
    category: 'video',
    icon: 'Film',
    color: '#e67e22',
    comingSoon: true,
    route: '/tools/extract-frames',
  },
  {
    id: 'text-to-pdf',
    name: 'Text to PDF',
    description: 'Convert plain text or rich text into a PDF document',
    category: 'document',
    icon: 'FileType',
    color: '#f39c12',
    comingSoon: true,
  ...
  },
  {
    id: 'pdf-to-pdfa',
    name: 'PDF to PDF/A',
    description: 'Convert PDF to the ISO-standardized archival format PDF/A',
    category: 'pdf',
    icon: 'Archive',
    color: '#e74c3c',
    comingSoon: true,
  ...
  },
  {
    id: 'pdf-repair',
    name: 'Repair PDF',
    description: 'Recover and repair corrupted or damaged PDF files',
    category: 'pdf',
    icon: 'Wrench',
    color: '#e74c3c',
    comingSoon: true,
